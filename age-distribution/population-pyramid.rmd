Pilsoņu un nepilsoņu vecumu piramīda
----------

[Uz sākumu](../index.html)

* **Anotācija:** Dots pilsoņu un nepilsoņu skaits atkarībā no dzimšanas gada. Izveidot vecumu piramīdu, kurā attēlots attiecīgi nepilsoņu un pilsoņu skaits. 
* **Šī pārskata šablons:** [population-pyramid.rmd](population-pyramid.rmd)
...
* **Iegūtais attēls:** [Vecumu piramīda](animC.gif)
