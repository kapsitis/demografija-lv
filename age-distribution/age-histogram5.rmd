...
saveGIF({
for (dset in dsets) {
#  png(paste0("age-histogram5-",dset,".png"), width=600, height=450)
...
}, movie.name = "age-histogram5-anim.gif", 
interval = c(rep(0.75,times=14),3.75), nmax = 30, ani.width = 600, 
ani.height = 450)
```

![Animēta histogramma (5-gadu intervāli)](figure-static/age-histogram5-anim.gif)
